...
export const pageQuery = graphql`
    query EnglishIndexQuery {
        Matthew: allPostsJson(filter: {bookName: {eq: "Matthew"}}) {
            edges {
              node {
                id
                bookId
        ...
        Mark: allPostsJson(filter: {bookName: {eq: "Mark"}}) {
        edges {
            node {
                id
                bookId
        ...
        Luke: allPostsJson(filter: {bookName: {eq: "Luke"}}) {
            edges {
              node {
                id
                bookId
        ...
        John: allPostsJson(filter: {bookName: {eq: "John"}}) {
        edges {
            node {
            id
            bookId
        ...
        Acts: allPostsJson(filter: {bookName: {eq: "Acts"}}) {
            edges {
              node {
                id
                bookId
